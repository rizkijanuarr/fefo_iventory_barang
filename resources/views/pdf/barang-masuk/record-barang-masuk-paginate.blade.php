...
<head>
    ...
    <title>Receipt Barang Masuk</title>
    <style>
        @page {
            size: 3.15in;
            margin: 0;
...
<body>
    <div>
        ...
        <h2 class="title">Receipt Barang Masuk</h2>
        ...
        <table>
            ...
            <tbody>
                @foreach ($barangMasuks as $index => $data)
                    <tr>
        ...
        <div class="footer">
            Halaman {{ $barangMasuks->currentPage() }} dari {{ $barangMasuks->lastPage() }}<br>
            Menampilkan {{ $barangMasuks->firstItem() }} - {{ $barangMasuks->lastItem() }} dari {{ $barangMasuks->total() }} barang masuk
        </div>
